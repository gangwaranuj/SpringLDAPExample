package com.thinksys.ldap.bean;
...
public class LdapConfigurationBean {
	...
	public String toString() {
		return "PropertiesBean [ldap_url=" + ldap_url + ", ldap_managerdn=" + ldap_managerdn + ", ldap_basesearch="
				+ ldap_basesearch + ", ldap_groupsearch=" + ldap_groupsearch + ", ldap_managerpassword="
